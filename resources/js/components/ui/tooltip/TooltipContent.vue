...
const props = withDefaults(defineProps<TooltipContentProps & { class?: HTMLAttributes['class'], arrowClass?: HTMLAttributes['class'], hideArrow?: boolean }>(), {
    sideOffset: 4,
})
...
<template>
  <TooltipPortal>
    ...
    >
      ...
      <TooltipArrow v-if="!hideArrow" :class="cn('bg-primary fill-primary z-50 size-2.5 translate-y-[calc(-50%_-_2px)] rotate-45 rounded-[2px]', arrowClass)" />
    </TooltipContent>
  </TooltipPortal>
</template>
