...
use App\Services\GeoIP\MaxMindDatabaseService;
use App\Services\GeoIP\MaxMindWebServiceService;
...
return [
    ...
    */
    ...
    'services' => [
        ...
        'maxmind_database' => [
            'class' => MaxMindDatabaseService::class,
            'database_path' => storage_path('app/GeoLite2-Country.mmdb'),
            'locales' => ['en'],
        ],

        'maxmind_api' => [
            'class' => MaxMindWebServiceService::class,
            'locales' => ['en'],
        ],
