...
return [
    ...
    'release_feed_url' => env('RELEASE_FEED_URL') ?: 'https://github.com/weblexai/weblexai-community/releases/latest/download/stable.json',
    'release_public_key' => env('RELEASE_PUBLIC_KEY') ?: 'zmQC1sHMkYYb01WwmEzFpbIYK/hCSra2hQBw+eVWr9M=',
